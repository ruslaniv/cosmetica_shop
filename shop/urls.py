...
urlpatterns = [
  ...
  path('<slug:category_slug>/', views.CategoryView.as_view(), name='product_list_by_category'),
  path('<slug:brand_slug>/', views.BrandView.as_view(), name='product_list_by_brand'),
